...
func init() {
	//订单
	beego.Router("/fabric/index", &controllers.FabricController{}, "*:Index")
	beego.Router("/fabric/edit/?:id", &controllers.FabricController{}, "Get,Post:Edit")
	beego.Router("/fabric/list", &controllers.FabricController{}, "Post:List")
	beego.Router("/fabric/delete",&controllers.FabricController{},"Post:Delete")
	beego.Router("/fabric/print",&controllers.FabricController{},"Get:Print")
	//用户角色路由
